import{_ as t}from"./plugin-vue_export-helper-c27b6911.js";import{r as o,o as e,c,d as l,e as a,a as n,b as s}from"./app-706bfe03.js";const k={},u=a(`<h1 id="链表" tabindex="-1"><a class="header-anchor" href="#链表" aria-hidden="true">#</a> 链表</h1><p>链表相关的问题基本都是双指针解决的，其中快慢指针常用于判断链表是否成环。</p><h2 id="合并、分隔链表" tabindex="-1"><a class="header-anchor" href="#合并、分隔链表" aria-hidden="true">#</a> 合并、分隔链表</h2><h3 id="合并两个有序链表-21" tabindex="-1"><a class="header-anchor" href="#合并两个有序链表-21" aria-hidden="true">#</a> 合并两个有序链表 ( 21 )</h3><p>将两个有序链表合并为一个新的升序链表并返回。</p><p>这个问题比较简单，类似归并排序的 merge 操作，用两个指针，值小的节点先合并，直到其中一条链表为空，将剩余的节点直接拼接到新链表上。</p><div class="language-javascript" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">mergeTwoLists</span><span class="token punctuation">(</span><span class="token parameter">list1<span class="token punctuation">,</span> list2</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre></div><p>代码中用到了链表算法题中常见的虚拟头结点 ( dummy ) 技巧，有了 dummy 节点作为占位符，可以避免出现空指针。</p><p><strong>每当你需要创建一条新链表时，建议都使用 dummy 节点，可以减少很多麻烦。</strong></p><h3 id="合并-k-个有序链表-23" tabindex="-1"><a class="header-anchor" href="#合并-k-个有序链表-23" aria-hidden="true">#</a> 合并 k 个有序链表 ( 23 )</h3><p>这是面试常考题。整体思路与“合并两个有序链表”是一样的，问题在于，如何快速找到 k 个链表的最小节点，答案是<strong>优先级队列 ( 最小堆 )</strong>。</p><div class="language-javascript" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">mergeKLists</span><span class="token punctuation">(</span><span class="token parameter">lists</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre></div><p>这道题中虚拟头结点的作用就很明显了，没有虚拟头结点，就需要各种空指针的判断，代码会复杂很多。</p><h2 id="链表的第-k-节点" tabindex="-1"><a class="header-anchor" href="#链表的第-k-节点" aria-hidden="true">#</a> 链表的第 k 节点</h2><h3 id="倒数第-k-个" tabindex="-1"><a class="header-anchor" href="#倒数第-k-个" aria-hidden="true">#</a> 倒数第 k 个</h3><p>假设一个链表有 n 个节点，那么倒数第 k 节点就是顺数第 <code>n - k + 1</code> 节点。然而，链表的长度通常是未知的，我们需要先遍历一遍链表得到 n，再遍历 <code>n - k + 1</code> 次找到倒数第 k 个节点。</p><p>上述做法需要遍历两次，用双指针技巧只需遍历一次。</p><ol><li>左指针不动，右指针往前走 k 步，左右指针形成长度为 k + 1 的区间</li><li>左右指针同时移动，直到右指针到达尾部 null 节点，左指针正好是倒数第 k 个节点</li></ol><p><img src="https://raw.githubusercontent.com/yamsfeer/pic-bed/master/链表-倒数第k个节点.svg" alt=""></p><p>实现代码如下：</p><div class="language-javascript" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">findFromEnd</span><span class="token punctuation">(</span><span class="token parameter">head<span class="token punctuation">,</span> k</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre></div><h3 id="删除倒数第-k-个-19" tabindex="-1"><a class="header-anchor" href="#删除倒数第-k-个-19" aria-hidden="true">#</a> 删除倒数第 k 个 ( 19 )</h3><p>有了上述 <code>findFromEnd</code> 函数后，要删除倒数第 k 个节点就比较容易了，只需找到倒数第 k + 1 个节点，然后删除下一个节点即可。</p><div class="language-javascript" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">removeNthFromEnd</span><span class="token punctuation">(</span><span class="token parameter">head<span class="token punctuation">,</span> k</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token keyword">return</span> dummy<span class="token punctuation">.</span>next
<span class="token punctuation">}</span>
</code></pre></div><p>代码中虚拟头结点也是为了防止出现空指针。假如要删除的是第 1 个节点，那么它的前一个节点是不存在的，虚拟头结点可以解决这个问题。</p><h2 id="链表的快慢指针" tabindex="-1"><a class="header-anchor" href="#链表的快慢指针" aria-hidden="true">#</a> 链表的快慢指针</h2><h3 id="链表的中点-876" tabindex="-1"><a class="header-anchor" href="#链表的中点-876" aria-hidden="true">#</a> 链表的中点 ( 876 )</h3><p>在不知道链表长度的情况下，要找出链表的中间节点，需要用到快慢指针。</p><ol><li>slow、fast 指针指向头结点 head</li><li>slow 每次前进 1 步，fast 每次前进 2 步</li><li>当 fast 到达尾部 null 节点，slow 则指向中间节点</li></ol><div class="language-javascript" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">middleNode</span><span class="token punctuation">(</span><span class="token parameter">head</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre></div><p>需要注意的是，如果链表长度为偶数，说明有两个中间节点，快慢指针算法得到的是后一个中间节点。</p><h3 id="判断链表是否包含环" tabindex="-1"><a class="header-anchor" href="#判断链表是否包含环" aria-hidden="true">#</a> 判断链表是否包含环</h3><p>快慢指针对判断链表是否成环非常有用。</p><ul><li>如果链表没有环，fast 到达尾部时，slow 会指向中点</li><li>如果链表含有环，slow、fast 指针最终会相遇</li></ul><div class="language-javascript" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">hasCycle</span><span class="token punctuation">(</span><span class="token parameter">head</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  <span class="token keyword">let</span> slow <span class="token operator">=</span> head<span class="token punctuation">,</span> fast <span class="token operator">=</span> head
  <span class="token keyword">while</span><span class="token punctuation">(</span>fast <span class="token operator">!==</span> <span class="token keyword">null</span> <span class="token operator">&amp;&amp;</span> fast<span class="token punctuation">.</span>next <span class="token operator">==</span> <span class="token keyword">null</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    slow <span class="token operator">=</span> slow<span class="token punctuation">.</span>next
    fast <span class="token operator">=</span> fast<span class="token punctuation">.</span>next<span class="token punctuation">.</span>next
...
<span class="token punctuation">}</span>
  ...
  <span class="token keyword">return</span> slow
<span class="token punctuation">}</span>
</code></pre></div><p>顺便说一句，fast 比 slow 多走的 k 步其实是 fast 在环内转圈，所以 k 是环长度的整数倍。</p><p>总结一下，快慢指针第一次相遇说明有环，同速前进相遇找到环起点。</p><p>以上做法的证明比较麻烦，我们可以借助额外空间使这个问题变简单。</p><p>我们用一个集合保存所有访问过的节点，当出现访问过的节点，这个节点就是起点。</p><div class="language-javascript" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">detectCycle</span><span class="token punctuation">(</span><span class="token parameter">head</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token keyword">return</span> <span class="token keyword">null</span>
<span class="token punctuation">}</span>
</code></pre></div><h2 id="相交链表-160" tabindex="-1"><a class="header-anchor" href="#相交链表-160" aria-hidden="true">#</a> 相交链表 ( 160 )</h2><p>给定两个链表的头结点 headA 和 headB，如果两个链表相交，返回相交节点，不相交则返回 null。</p><p>比如下面的两个链表相交于 c1 节点。</p>`,44),d=a(`<p>如果使用常见的双指针技巧，p1 和 p2 两个指针分别在两条链表上前进，并不能同时走到公共节点。</p><p>解决这个问题的关键在于：通过某种方式，让 p1、p2 同时到达相交节点。</p><p>我们让 p1 遍历完链表 A 后开始遍历链表 B，p2 遍历完链表 B 后开始遍历链表 A。</p><p>其实这样相当于将两条链表首尾连在一起，这样它们的长度就一样了，最终它们会在相交点相遇。</p><div class="language-javascript" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">getIntersectionNode</span><span class="token punctuation">(</span><span class="token parameter">headA<span class="token punctuation">,</span> headB</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
